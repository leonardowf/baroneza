...
import { GithubPullRequestExtractor, ConcreteJiraTickerParser } from "./repositories/github-repository";
...
export class Dependencies implements TagEndpointDependencies, JiraTagUseCaseDependencies {
    ...
    commitExtractor = new GithubPullRequestExtractor(this.octokit(), this.config.githubOwner, this.config.githubRepo)
